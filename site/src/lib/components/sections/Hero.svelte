<h2 class="text-3xl sm:text-4xl font-bold text-white leading-tight tracking-tight border-l-4 border-indigo-500 pl-6 py-1">
  When does recursive, reference-indexed bounded execution outperform naive long-context
  prompting for long-running agent tasks?
</h2>
