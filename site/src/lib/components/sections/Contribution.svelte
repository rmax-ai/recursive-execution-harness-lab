<blockquote class="border border-slate-800 bg-slate-900/50 rounded-lg p-8 italic text-lg text-white leading-relaxed">
  ...
  state into recursive execution, evidence stores, and verification gates?
</blockquote>
